...
(defn parse
  ...
  (case te
    ...
    "iri-test" 
    ;["https://jon:password@juxt.pro:8080/site/index.html?debug=true#bar" "https:" "https" "//jon:password@" "jon:password" "d" "juxt.pro:" "juxt.pro" "8080" "/site/index.html" "/index.html" "debug=true" "e" "bar" "r"]
    (if-let [[_ _ scheme _ user _ _ host port path _ query _  fragment _] (re-matches IRI instance)] [scheme user host port path query fragment] "Not found")))
