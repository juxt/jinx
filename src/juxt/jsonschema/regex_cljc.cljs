...
(defn parse
  ...
  (case te
    ...
    "iri-test"
    ;["http://user:password@example.com:8080/path/ererwer?query=value#fragment" "http:" "http" "//user:password@" "user:password@" "user:password" "d" "example.com:8080" "example.com" "8080" "/path/ererwer" "/ererwer" "query=value" "e" "fragment" "t"]
    ;["http://user:password@example.com:8080/path/ererwer?query=value#fragment" "http:" "http" "//user:password@" "user:password@" "user:password" "d" "example.com" "8080" "/path/ererwer" "/ererwer" "query=value" "e" "fragment" "t"]
    (if-let [[_ _ scheme _ _ user _  _ host port path _ query _  fragment _] (re-matches IRI instance)] [scheme user host port path query fragment] "Not found")))
